<template>
  <section class="tableContain">
    ...
    <el-col :span="24" class="toolbar">
      ...
      <el-pagination layout="total, sizes, prev, pager, next, jumper" @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-size="size" :total="total" style="float:right;"></el-pagination>
    </el-col>
  ...
  export default {
      ...
      methods: {
          formatSex: function(row, column){
              return row.sex == 1 ? '男' : row.sex == 0 ? '女' : '请选择';
          },
          ...
          handleEdit: function(index, row){
              ...
              this.editForm = Object.assign({}, row);//深拷贝
          },
          //显示新增页面
          handleAdd: function() {
